export default {
  ...
  login: {
    ...
    notice: `EchoNote promises not to save any of your account information to the cloud.<br />
      Your password will be MD5 encrypted locally and then transmitted to NetEase Music API.<br />
      EchoNote is not the official website of NetEase Music, please consider carefully before entering account information. You can also build and use the self-hosted NetEase Cloud API.`,
    noticeElectron: `Your password will be MD5 encrypted locally and then transmitted to NetEase Music API.<br />
      EchoNote promises not to save any of your account information to the cloud.<br />`,
  },
  mv: {
